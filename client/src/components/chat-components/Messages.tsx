  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute transition-all flex duration-300  cursor-pointer bg-primary top-[5rem] left-1/2 lg:left-[80rem] -translate-x-1/2  items-center justify-center rounded-full ${
